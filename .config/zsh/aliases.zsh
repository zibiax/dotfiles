...
alias upgrade='paru && sudo pacman -Syyuu && paru -sc' # update script
...
alias hyprswitch='/home/martin/bin/hyprswitch.sh' # Switch between one screen and multiscreen in hyprland
alias ollama-pull='/home/martin/bin/ollama_pull.sh' # Pulls models
alias yeet='paru -Rcs' # Uninstall programs recursively
